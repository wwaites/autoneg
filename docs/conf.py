# -*- coding: utf-8 -*-
#
# autoneg python documentation build configuration file, created by
...
release = get_distribution("autoneg").version
...
latex_documents = [
  ('index', 'autoneg.tex', u'autoneg documentation',
...
man_pages = [
    ('index', 'autoneg', u'autoneg documentation',
     [u'William Waites'], 1)
]
